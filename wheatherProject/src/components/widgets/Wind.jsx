...
function Wind() {
  ...
  return (
    <>
      {isSuccess && (
        <div className="flex h-40 w-full flex-col overflow-hidden rounded-3xl bg-white p-4 shadow-lg dark:bg-neutral-800">
          {/* TITLE */}
          ...
          <div className="relative -mt-1 flex h-full w-full flex-col content-center items-center align-middle">
            ...
            <div className="absolute h-32 w-32 dark:invert">
              <svg
                className="ease-in-out will-change-transform"
